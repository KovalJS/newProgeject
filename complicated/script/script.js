...
let appData = {
    ...
    addExpensesBlock : function() {           //Добавляет новые поля 
        ...
        cloneExpensesItem.querySelector('.expenses-title').value = ''; //инпуты добавляются пустые без value
    ...
    addIncomeBlock: function() {
        ...
        cloneIncomeItem.querySelector('.income-title').value = ''; //инпуты добавляются пустые без value
    ...
    inputElement.forEach(function(item) {    //placeholder="Наименование" разрешить ввод только русских букв
        ...
        if (item.placeholder === 'Сумма') {      //placeholder="Сумма" разрешить ввод только цифр
            item.addEventListener('input', function() {
